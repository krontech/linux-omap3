...
static struct omap_board_mux board_mux[] __initdata = {
	/* PIN mux for video port */
	TI816X_MUX(TSI1_DCLK,    OMAP_MUX_MODE2), /* vin1_d9 */
	TI816X_MUX(TSI1_DATA,    OMAP_MUX_MODE2), /* vin1_d10 */
	TI816X_MUX(TSI1_BYTSTRT, OMAP_MUX_MODE2), /* vin1_d11 */
	TI816X_MUX(TSI1_PACVAL,  OMAP_MUX_MODE2), /* vin1_d12 */
	TI816X_MUX(TSI1_PACERR,  OMAP_MUX_MODE2), /* vin1_d13 */
	TI816X_MUX(TSI2_DCLK,    OMAP_MUX_MODE1), /* vin1_d14 */
	TI816X_MUX(TSI2_DATA,    OMAP_MUX_MODE1), /* vin0_d20 */
	TI816X_MUX(TSI2_BYTSTRT, OMAP_MUX_MODE1), /* vin0_d21 */
	TI816X_MUX(TSI2_PACVAL,  OMAP_MUX_MODE1), /* vin0_d22 */
	TI816X_MUX(TSI2_PACERR,  OMAP_MUX_MODE1), /* vin0_d23 */
	TI816X_MUX(TSI3_DCLK,    OMAP_MUX_MODE2), /* vin1_d4 */
	TI816X_MUX(TSI3_DATA,    OMAP_MUX_MODE2), /* vin1_d5 */
	TI816X_MUX(TSI3_BYTSTRT, OMAP_MUX_MODE2), /* vin1_d6 */
	TI816X_MUX(TSI3_PACVAL,  OMAP_MUX_MODE2), /* vin1_d7 */
	TI816X_MUX(TSI3_PACERR,  OMAP_MUX_MODE2), /* vin1_d8 */
	TI816X_MUX(TSI4_DCLK,    OMAP_MUX_MODE2), /* vin1_d15 */
	TI816X_MUX(TSI4_DATA,    OMAP_MUX_MODE1), /* vin0_d16 */
	TI816X_MUX(VIN0_D17,     OMAP_MUX_MODE1), /* vin0_d17 */
	TI816X_MUX(TSI4_PACVAL,  OMAP_MUX_MODE1), /* vin0_d18 */
	TI816X_MUX(TSI4_PACERR,  OMAP_MUX_MODE1), /* vin0_d19 */
	TI816X_MUX(TSI5_DCLK,    OMAP_MUX_MODE1), /* vout0_r_cr0 */
	TI816X_MUX(TSI5_DATA,    OMAP_MUX_MODE1), /* vout0_b_cb_c0 */
	TI816X_MUX(TSI5_BYTSTRT, OMAP_MUX_MODE1), /* vout0_b_cb_c1 */
	TI816X_MUX(TSI5_PACVAL,  OMAP_MUX_MODE1), /* vout0_g_y_yc0 */
	TI816X_MUX(TSI5_PACERR,  OMAP_MUX_MODE1), /* vout0_g_y_yc1 */
	TI816X_MUX(TSI6_DCLK,    OMAP_MUX_MODE2), /* vin1_clk1 */
	TI816X_MUX(TSI6_DATA,    OMAP_MUX_MODE1), /* vin0_hsync0 */
	TI816X_MUX(TSI6_BYTSTRT, OMAP_MUX_MODE1), /* vin0_vsync0 */
	TI816X_MUX(TSI6_PACVAL,  OMAP_MUX_MODE1), /* vin0_fld0 */
	TI816X_MUX(TSI6_PACERR,  OMAP_MUX_MODE1), /* vin0_de0 */
	TI816X_MUX(TSI7_DCLK,    OMAP_MUX_MODE1), /* vout0_hsync */
	TI816X_MUX(TSI7_DATA,    OMAP_MUX_MODE1), /* vout0_vsync */
	TI816X_MUX(TSI7_BYTSTRT, OMAP_MUX_MODE1), /* vout0_fld */
	TI816X_MUX(TSI7_PACVAL,  OMAP_MUX_MODE1), /* vout0_avid */
	TI816X_MUX(TSI7_PACERR,  OMAP_MUX_MODE1), /* vout0_r_cr1 */
	TI816X_MUX(TSO1_DCLK,    OMAP_MUX_MODE2), /* vin1_clk0 */
	TI816X_MUX(TSO1_DATA,    OMAP_MUX_MODE2), /* vin1_d0 */
	TI816X_MUX(TSO1_BYTSTRT, OMAP_MUX_MODE2), /* vin1_d1 */
	TI816X_MUX(TSO1_PACVAL,  OMAP_MUX_MODE2), /* vin1_d2 */
	TI816X_MUX(TSO1_PACERR,  OMAP_MUX_MODE2), /* vin1_d3 */
	TI816X_MUX(VOUT0_R_CR2,  OMAP_MUX_MODE0), /* vout0_r_cr2 */
	TI816X_MUX(VOUT0_R_CR3,  OMAP_MUX_MODE0), /* vout0_r_cr3 */
	TI816X_MUX(VOUT0_R_CR4,  OMAP_MUX_MODE0), /* vout0_r_cr4 */
	TI816X_MUX(VOUT0_R_CR5,  OMAP_MUX_MODE0), /* vout0_r_cr5 */
	TI816X_MUX(VOUT0_R_CR6,  OMAP_MUX_MODE0), /* vout0_r_cr6 */
	TI816X_MUX(VOUT0_R_CR7,  OMAP_MUX_MODE0), /* vout0_r_cr7 */
	TI816X_MUX(VOUT0_R_CR8,  OMAP_MUX_MODE0), /* vout0_r_cr8 */
	TI816X_MUX(VOUT0_R_CR9,  OMAP_MUX_MODE0), /* vout0_r_cr9 */
	TI816X_MUX(IIC1_SCL,     OMAP_MUX_MODE0 | OMAP_PULL_UP);
	TI816X_MUX(IIC1_SDA,     OMAP_MUX_MODE0 | OMAP_PULL_UP);
