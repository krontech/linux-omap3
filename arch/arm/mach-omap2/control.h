...
#define TI81XX_CTRL_REGADDR(reg)					\
		OMAP2_L4_IO_ADDRESS(TI81XX_CTRL_BASE + (reg))
#else
#define OMAP242X_CTRL_REGADDR(reg)					\
		OMAP2_L4_IO_ADDRESS(OMAP242X_CTRL_BASE + (reg))
#define OMAP243X_CTRL_REGADDR(reg)					\
...
#define TI81XX_DEV_FEATURE		0x604
#define TI81XX_DSP_SHIFT		31
#define TI81XX_DSP_MASK			(1 << TI81XX_DSP_SHIFT)
#define TI81XX_SGX_SHIFT		29
#define TI81XX_SGX_MASK			(1 << TI81XX_SGX_SHIFT)
